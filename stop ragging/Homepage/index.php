            ...
            <div class="div1">
                ...
                <div class="nav_menu">
                    <ul>
                        ...
                        <li><a href="../victim/victim.php">Victim</a></li>
                        <li><a href="../public/public.php">Read all Post </a></li>
                ...
                <div class="function">
                    ...
                    <div class="div22">
                        <ul>
                            ...
                            <li class="button2"><a href="../authoritymyself/index.php">Continue as a Authority</a></li>
                            <!-- <li class="button2"><a href="../authority/authority3.php">Continue as a Authority</a></li> -->
